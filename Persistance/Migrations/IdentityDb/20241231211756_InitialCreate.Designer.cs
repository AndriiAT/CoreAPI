...
namespace Persistance.Migrations.IdentityDb
{
    ...
    [Migration("20241231211756_InitialCreate")]
            ...
            modelBuilder.Entity("Persistance.Models.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "admin-role-id",
                            CreatedDate = new DateTime(2024, 12, 31, 21, 17, 56, 264, DateTimeKind.Utc).AddTicks(2305),
            ...
            modelBuilder.Entity("Persistance.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "admin-user-id",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3d2566d2-328a-416e-a3ca-478440e1fbcc",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEKxo11n3hYlF2gn5DAGs14H+rrNRjrQdwQlEmeQiHmiGun6KHo+xZEz61k0fmJ+uSg==",
